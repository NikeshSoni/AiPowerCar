...
-- CreateEnum
CREATE TYPE "BookingStatus" AS ENUM ('PENDING', 'CONFIRMED', 'COMPLATED', 'CANCELLED', 'NO_SHOW');
...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Vahiql Moters',
    "address" TEXT NOT NULL DEFAULT 'Mumbai Maharashtra',
    "phone" TEXT NOT NULL DEFAULT '+1 (000) 800-4321',
    "email" TEXT NOT NULL DEFAULT 'contact@email.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "WorkingHour_dealershipId_dayOfWeek_idx" ON "WorkingHour"("dealershipId", "dayOfWeek");
