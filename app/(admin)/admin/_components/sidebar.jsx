                ...
                {routes.map((route, idx) => {
                    return (
                        <Link href={route.href} key={idx}
                            className={
                                cn("flex items-center gap-x-2 h-12 text-slate-500 text-sm font-medium pl-6 transition-all hover:text-slate-600 hover:bg-slate-100/50",
                                    pathName === route.href ? "text-blue-700 hover:bg-blue-100 hover:text-blue-700" : "")
                            }
                        >
            ...
            <div className='md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t 
                ...
                {routes.map((route, idx) => {
                    return (
                        <Link href={route.href} key={idx}
                            className={
                                cn("flex flex-col items-center justify-center text-slate-500 text-xs font-medium transition-all py-1 flex-1",
